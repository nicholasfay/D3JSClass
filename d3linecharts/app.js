...
//Create line
//Defined lets you filter out data points to not be drawn on the line path
var line = d3.line()
                .defined((d) => {
...
//Datum is used here as the eventual line that is made is just one element so all the  data needs to be bound to that one element
